...
test_bow_train_accuracy, test_peg_val_accuracy = \
   p1.classifier_accuracy(p1.pegasos, train_bow_features, test_bow_features, train_labels, test_labels, T=25, L=0.01)
print("{:50} {:.4f}".format("Training test accuracy for Pegasos:", test_bow_train_accuracy))
print("{:50} {:.4f}".format("Validation test accuracy for Pegasos:", test_peg_val_accuracy))
...
best_theta, best_theta_0 = p1.pegasos(train_bow_features, train_labels, T=25, L=0.01) # Your code here
